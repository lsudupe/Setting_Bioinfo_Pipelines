...
# Store all of them
topTable_all <- topTable(fit)
topTable_q1 <- topTable(fit, coef=1) # Results for the first contrast
topTable_q2 <- topTable(fit, coef=2) # Results for the second contrast
